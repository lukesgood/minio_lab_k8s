...
echo ""
echo "# Lab Guide를 순서대로 따라하며 실습 진행"
echo "# docs/ 디렉토리의 LAB-XX-GUIDE.md 파일들을 참조하세요"
echo ""
if [ "$ENVIRONMENT_TYPE" = "single-node" ]; then
    echo "# 단일 노드 환경 권장 실습 순서:"
else
    echo "# 다중 노드 환경 권장 실습 순서:"
fi
...
echo "docs/LAB-04-GUIDE.md  # S3 API 고급 기능"
echo "docs/LAB-05-GUIDE.md  # 성능 테스트"
echo "docs/LAB-06-GUIDE.md  # 사용자 및 권한 관리"
...
echo "   - Kubernetes 환경 구성: K8S_SETUP_GUIDE.md"
